= Couchbase Kotlin SDK Documentation

This repository hosts the documentation source for the https://docs.couchbase.com/kotlin-sdk/3.9/hello-world/overview.html[Couchbase Kotlin SDK].
...
This branch reflects the new Information Architecture for the SDK docs -- this release was previously documented with the old structure (those old docs can be found under the `temp/1.5` branch), and docs with this structure can be seen on the Couchbase docs site for releases 1.5 and earlier.

IMPORTANT: The leap from 1.5 to 3.9 is part of the effort to align all of the Couchbase JVM monorepo,
You can see how the versions line up in the table at https://docs.couchbase.com/kotlin-sdk/current/project-docs/compatibility.html#api-version[https://docs.couchbase.com/kotlin-sdk/current/project-docs/compatibility.html#api-version].
...
If you are not sure of the best way to update the docs, please raise a https://github.com/couchbase/docs-sdk-kotlin/issues[GitHub issue] with your suggestion, putting in as much information as possible.


== Notes for Docs Maintainers

The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/kotlin-sdk/3.9/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
...
| `name_platform:` | Allows us to name the SDK within shared content (*Kotlin*).

| `name-sdk:` | Allows us to name the SDK within shared content (*Kotlin SDK*).
...
Production branches use the *release/x.y* naming pattern (e.g. `release/3.8`, `release/3.9`).
