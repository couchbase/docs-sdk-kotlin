...
This repository hosts the documentation source for the https://docs.couchbase.com/kotlin-sdk/3.12/hello-world/overview.html[Couchbase Kotlin SDK].

This branch documents the 3.12 release of the SDK.
It follows the https://docs.couchbase.com/kotlin-sdk/3.12/project-docs/compatibility.html#api-version[SDK 3.10 API].
...
The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/kotlin-sdk/3.12/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
...
A value of `3` should not be used, save in exceptionally complicated pages like that shown (the https://docs.couchbase.com/kotlin-sdk/3.12/project-docs/compatibility.html[compatibility page]).
...
* antora.yml
* build.gradle
* modules/devguide/examples/kotlin/pom.xml
