= Client Settings for the Kotlin SDK
:description: pass:q[The `ClusterEnvironment` class enables you to configure Kotlin SDK options for security, timeouts, reliability, and performance.]
