...
https://docs.couchbase.com/sdk-api/couchbase-kotlin-client-3.12.3/index.html[API Reference] |
...
* https://jira.issues.couchbase.com/browse/KCBC-214[KCBC-214]:
Fixed a regression in 3.12.0 that caused the SDK to fail to execute transaction lambdas.
