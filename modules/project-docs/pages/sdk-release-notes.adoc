...
NOTE: From 3.9.0 on, all Couchbase JVM SDKs have an aligned version number to make it easier to users to track changes. So the version jumped from 1.5.x to 3.9.x.
