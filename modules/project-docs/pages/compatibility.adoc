...
The Kotlin SDK requires Java 8 or later (_Java 25 is recommended_),
and Kotlin 2.1.0 or later.
...
We recommend running the latest LTS version (i.e. at the time of writing JDK 25) with the highest patch version available.
...
| Vector Search
| N/A
2+| From SDK 1.3.0 (base64 encoded vectors from 1.4.0)

| Preferred Server Group Replica Reads
| N/A
2+| From SDK 1.5.0 (with Server 7.6.2 onwards)
