...
The Kotlin SDK requires Java 8 or later (_Java 21 is recommended_),
and Kotlin 1.9.0 or later.
...
M1 ARM  architecture is fully supported in the Kotlin SDK.
