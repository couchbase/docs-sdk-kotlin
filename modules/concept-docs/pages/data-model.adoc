...
These data structures are stored as JSON documents in Couchbase, and can therefore be accessed using Query, Full Text Search, and normal key-value operations.
