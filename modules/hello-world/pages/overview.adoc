...
* You will need Java 8 or later, and Kotlin 1.6.20 or later.
We recommend running the latest Java LTS version with the highest patch version available, and the latest version of Kotlin.
...
Here's an example that shows how to execute a N1QL query and get a document from the Key Value (KV) service.
