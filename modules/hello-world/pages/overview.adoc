...
The latest version (as of January 2022) is https://search.maven.org/artifact/com.couchbase.client/kotlin-client/1.0.0-dp.5/jar[1.0.0-dp.5].
...
[source,groovy]
----
implementation 'com.couchbase.client:kotlin-client:1.0.0-dp.5'
----
...
The API reference can be found https://docs.couchbase.com/sdk-api/couchbase-kotlin-client-1.0.0-dp.5/[here].
