...
The latest version (as of March 2022) is https://search.maven.org/artifact/com.couchbase.client/kotlin-client/{kotlin-current-version}/jar[{kotlin-current-version}].
