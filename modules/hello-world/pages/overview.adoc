...
The latest version (as of February 2022) is https://search.maven.org/artifact/com.couchbase.client/kotlin-client/1.0.0-dp.6/jar[1.0.0-dp.6].
...
[source,groovy]
----
implementation("com.couchbase.client:kotlin-client:1.0.0-dp.6")
----
...
The API reference can be found https://docs.couchbase.com/sdk-api/couchbase-kotlin-client-1.0.0-dp.6/[here].
