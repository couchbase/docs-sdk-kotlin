...
WARNING: These pages cover the _Developer Preview_ of the Couchbase Kotlin SDK 1.0 (DP).
...
The latest version (as of September 2021) is https://search.maven.org/artifact/com.couchbase.client/couchbase-kotlin-client/1.0.0-dp.2/jar[1.0.0-dp.2].
...
[source,groovy]
----
implementation 'com.couchbase.client:kotlin-client:1.0.0-dp.2'
----
...
The API reference can be found https://docs.couchbase.com/sdk-api/couchbase-kotlin-client/[here].
