...
If you were not, you can still find it https://github.com/couchbase-examples/kotlin-quickstart[here].
...
The https://github.com/couchbase-examples/kotlin-quickstart[quickstart project] is designed to teach you and give you a starter project (in Kotlin, using Ktor) to generate such a REST API.
...
can be found on the https://developer.couchbase.com/tutorial-quickstart-kotlin-ktor/[Couchbase Developer Portal].
