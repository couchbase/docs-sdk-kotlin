...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=bucket,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=collection,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=json,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=upsert,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=get,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=get-map,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=get-for,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=replace-options,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/StartUsingCapella.kt[tag=replace-named,indent=0]
----
////
