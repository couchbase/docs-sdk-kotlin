...
To be more precise, it selects the top 3 categories from each partition executing the query, and then merge each partition's result into the final result.
