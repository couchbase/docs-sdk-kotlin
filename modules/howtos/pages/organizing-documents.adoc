...
The document ID can be any UTF-8 string not longer than 250 bytes.

The document value can be any kind of data (text or binary), with a maximum length of 20 https://simple.wikipedia.org/wiki/Mebibyte[MiB].
