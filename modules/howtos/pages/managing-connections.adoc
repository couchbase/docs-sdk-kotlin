...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=simpleconnect,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=multinodeconnect,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=customenv,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=shareclusterenvironment,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/managing_connections.java[tag=managing_connections_5,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/managing_connections.java[tag=managing_connections_6,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=tls,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=dnssrv,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/managing_connections.java[tag=managing_connections_8,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ClusterExample.java[tag=managing_connections_9,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=blockingtoasync,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=asynccluster,indent=0]
----
...
[source,kotlin]
----
include::devguide:example$kotlin/ManagingConnections.java[tag=reactivecluster,indent=0]
----
