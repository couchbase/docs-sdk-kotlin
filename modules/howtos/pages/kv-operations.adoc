...
[source,kotlin]
----
include::example$KvBasic.kt[tag=rangeScanAllDocuments,indent=0]
----
<1> The `ScanType.range()` method has two optional parameters: `from` and `to`.
...
[source,kotlin]
----
include::example$KvBasic.kt[tag=rangeScanPrefix,indent=0]
----
...
[source,kotlin]
----
include::example$KvBasic.kt[tag=rangeScanSample,indent=0]
----
...
[source,kotlin]
----
include::example$KvBasic.kt[tag=rangeScanAllDocumentIds,indent=0]
----
...
You can do a KV range scan to get documents even if you don't know their IDs.
However, it's faster to use {sqlpp} for this.
